...
function GrowAudienceSection() {
  return (
    ...
    <div className="container w-full justify-self-end md:data-[reverse='true']:order-1 md:data-[reverse='false']:order-2 lg:max-w-[500px]">
      ...
      <p className="text-gray-700 mb-6 lg:mb-8 leading-7">
        Visitors can subscribe to your bio link, and you can capture their data
        (email, phone, location) to Google Sheets or a webhook for easy
