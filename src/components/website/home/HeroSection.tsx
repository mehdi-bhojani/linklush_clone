    ...
    <section className="relative pt-[120px] pb-16 xs:pb-20 md:pt-[148px] md:pb-[120px] lg:pt-[150px] lg:pb-[200px] overflow-hidden flex justify-center items-center">
      ...
      <div className="container">
        <div className="grid gap-10 xs:gap-12 md:gap-14 lg:grid-cols-2 lg:gap-10 items-center">
          <section>
            <h1 className="text-4xl xs:text-5xl md:text-[64px] lg:text-[70px] font-bold mb-[10px] md:mb- leading-[37px] xs:leading-[49px] md:leading-[65px] lg:leading-[72px]">
              Ditch the mess. With One link in bio.
            </h1>
            <p className="mb-5 md:mb-6 leading-7">
              Showcase everything in one stunning bio page. Organize with
              sections, lock for privacy, and animate for impact. Craft your
              online presence. Sign up for free!
            </p>
            <div className="flex flex-wrap gap-4">
              <a
                className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-base font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-zinc-300 bg-zinc-900 text-zinc-50 shadow hover:bg-zinc-900/90 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-50/90 h-9 px-4 py-2 w-full xs:w-fit"
                href="/register"
              >
                Get started
                <svg
