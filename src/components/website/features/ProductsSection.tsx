    ...
    <section>
      <div className="container py-16 xs:py-20 md:py-[100px] lg:pt-[120px] border-b">
        <div className="grid items-center md:grid-cols-2 gap-y-12 gap-x-10 xs:gap-x-12 md:gap-x-16 lg:gap-x-14">
          <div
            className="w-full relative  entry-animate animate-fade-in"
            data-animate="true"
          >
          ...
          <div
            className="w-full  entry-animate animate-fade-in-down"
            data-animate="true"
          >
            ...
            <h3 className="font-bold text-[26px] xs:text-[32px] lg:text-[36px] mb-5 md:mb-6 leading-8 xs:leading-10 lg:leading-[46px] capitalize">
              Sell Seamlessly: Integrate Your Store
            </h3>
            <p className="text-gray-700 mb-6 lg:mb-8 leading-7">
              Effortless selling starts here. Connect your Shopify or
              WooCommerce store directly to your link in bio and showcase your
              products with ease. Manage everything in one place and turn your
              link into a powerful sales channel.
            </p>
