      ...
      <div className="grid items-center md:grid-cols-2 gap-y-12 gap-x-10 xs:gap-x-12 md:gap-x-16 lg:gap-x-14">
        ...
        >
          ...
          <p className="text-gray-700 mb-6 lg:mb-8 leading-7">
            Go beyond basic metrics with in-depth analytics for your bio link
            page. Gain valuable insights into your audience;s location,
            demographics, and referral sources. Integrate Microsoft Clarity and
            Facebook Pixel for even deeper insights.
          </p>
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            <div className="flex items-center gap-3">
              ...
              <h5 className="font-bold capitalize">Microsoft Clarity</h5>
            </div>
            <div className="flex items-center gap-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
