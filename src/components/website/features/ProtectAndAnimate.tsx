        ...
        <div className="grid items-center md:grid-cols-2 gap-y-12 gap-x-10 xs:gap-x-12 md:gap-x-16 lg:gap-x-14">
          ...
          >
            ...
            <h3 className="font-bold text-[26px] xs:text-[32px] lg:text-[36px] mb-5 md:mb-6 leading-8 xs:leading-10 lg:leading-[46px] capitalize">
              Protect &amp; Animate Your Content
            </h3>
            <p className="text-gray-700 mb-6 lg:mb-8 leading-7">
              Control access and grab attention. Protect exclusive content with
              code lock or subscribe lock. Animate your links, products, and
              videos to make them stand out. Craft a dynamic and engaging link
              in bio that keeps your audience hooked.
            </p>
            <div className="grid md:grid-cols-2 gap-6 md:gap-8">
              <div className="flex items-center gap-3">
                <svg
                  ...
                  className="tabler-icon tabler-icon-lock "
                >
              ...
              <div className="flex items-center gap-3">
                ...
                <h5 className="font-bold capitalize">Subscribe Lock</h5>{" "}
              </div>
              <div className="flex items-center gap-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="tabler-icon tabler-icon-keyframes "
                >
