          ...
          <div className="grid items-center md:grid-cols-2 gap-y-12 gap-x-10 xs:gap-x-12 md:gap-x-16 lg:gap-x-14">
            ...
            >
              ...
              <h3 className="font-bold text-[26px] xs:text-[32px] lg:text-[36px] mb-5 md:mb-6 leading-8 xs:leading-10 lg:leading-[46px] capitalize">
                Design Your Way: From Simple to Stunning
              </h3>
              <p className="text-gray-700 mb-6 lg:mb-8 leading-7">
                Create a link in bio that reflects your style. Choose from a
                variety of pre-designed themes in basic mode, or dive into
                advanced design options for complete customization. Control
                colors, fonts, and more to craft the perfect look.
              </p>
              <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                ...
                <div className="flex items-center gap-3">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="tabler-icon tabler-icon-wand "
                  >
                  ...
                  <h5 className="font-bold capitalize">Advanced Design Mode</h5>
                </div>
              </div>
            </div>
          </div>
