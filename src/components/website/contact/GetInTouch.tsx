      ...
      <section className="pt-[120px] pb-16 xs:pb-20 md:pt-[140px] md:pb-[100px] lg:pt-[160px] lg:pb-[120px]">
        <div className="container">
          <div className="grid gap-x-12 gap-y-7 lg:grid-cols-2">
            <div
              className=" entry-animate data-[animate='true']:animate-fade-in-down"
              data-animate="true"
            >
              <h2 className="font-medium tracking-widest uppercase mb-3 md:mb-4">
                Get in touch
              </h2>
              <h1 className="text-4xl xs:text-5xl md:text-[64px] lg:text-[70px] font-bold mb-[10px] md:mb-4">
                Contact us!
              </h1>
              <p className="text-gray-700 mb-5 md:mb-6 leading-7">
                Contact us to learn more about our link in bio tool and how it
                can help streamline your online presence!
              </p>
              <div>
                <form className="grid grid-cols-2 gap-y-7 gap-x-5 md:gap-y-8">
                  <div>
                    <label className="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 block mb-2 text-base font-medium">
                      Name
                    </label>
                    <input
            ...
            >
              <div className="rounded-2xl px-6 pt-8 pb-12 xs:px-8 xs:pt-10 md:pt-12 md:px-10 lg:px-12 lg:py-16 border bg-[url(' / assets / backgrounds / gradient - 5.jpg')] bg-cover bg-no-repeat bg-center">
                <h2 className="text-2xl md:text-[26px] mb-3 lg:mb-4 font-bold">
                  Contact details
                </h2>
                <p className="text-gray-700 mb-8 md:mb-10 leading-7">
                  Discover more about our link in bio tool. Get in touch to see
                  how it can amplify your online presence!
                </p>
                <div className="flex gap-3 mb-8">
                  ...
                  <div>
                    <h5 className="font-semibold text-sm md:text-base mb-3">
                      Email
                    </h5>
                    <a href="mailto:hello@linklu.sh">
