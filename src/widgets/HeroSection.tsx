                ...
                <div className="container">
                    <div className="grid gap-10 xs:gap-12 md:gap-14 lg:grid-cols-2 lg:gap-10 items-center">
                        ...
                        <section className="h-fit relative">
                            <div className="relative mx-auto shadow-2xl border-gray-800 border-[17px] rounded-[2.5rem] h-[600px] w-[300px]">
                                <div className="h-[32px] w-[3px] bg-gray-800 absolute -start-[17px] top-[72px] rounded-s-lg"></div>
                                <div className="h-[46px] w-[3px] bg-gray-800 absolute -start-[17px] top-[124px] rounded-s-lg"></div>
                                <div className="h-[46px] w-[3px] bg-gray-800 absolute -start-[17px] top-[178px] rounded-s-lg"></div>
                                <div className="h-[64px] w-[3px] bg-gray-800 absolute -end-[17px] top-[142px] rounded-e-lg"></div>
                                <div className="rounded-[1rem] overflow-hidden w-[270px] h-[570px] bg-white">
